    ...
    <template #main>
      <main class="min-h-screen w-full z-10">
        <div class="px-3 py-4 flex flex-col space-y-3">
          <h1 class="font-bold text-xl text-black/70">My Cash</h1>
          <div class="flex gap-2 shadow w-full p-3 rounded">
            <BaseButton
              :id="'createNewCashBtn'"
              :type="'button'"
              :variant="'dark'"
            ...
            <template #tableBody>
              <thead class="text-black/80 border-b border-black/20 text-center">
                <tr>
                  <th
                    scope="col"
                    class="text-sm lg:text-lg px-4 py-2 font-medium"
                  >
                    Name
                  </th>
                  <th
              ...
              <tbody class="text-black/70" v-if="mockCashApi.length <= 0">
                <tr>
                  <td class="font-bold text-sm text-center py-10" colspan="4">
                    No data available
                  </td>
                </tr>
              </tbody>
            ...
            <template #header>
              <div class="flex items-center justify-between">
                ...
                <button class="group" type="button" @click="closeModal">
                  <svg
                    class="stroke-black/80 group-hover:stroke-red-500 transition-all ease-in-out duration-300"
                    xmlns="http://www.w3.org/2000/svg"
                    width="22"
                    height="22"
                    viewBox="0 0 24 24"
